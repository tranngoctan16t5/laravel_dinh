...
<div class="card card-info">
   ...
   <div class="card-block">
      <section class="mod-course">
         <div class="container">
            <form action="{{route('reports.store')}}" accept-charset="UTF-8" method="post">
                @csrf
               ...
               <div class="form-group">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <textarea class="form-control" name="done" id="report_work_today"></textarea>
                     </div>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <textarea class="form-control" name="block" id="report_problem"></textarea>
                     </div>
                  </div>
               </div>
