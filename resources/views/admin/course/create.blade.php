    ...
    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('courses.store') }}"  >
        ...
        <div class="box-body">
            <div class="form-group ">
                ...
                <label >Name</label>
                <input type="text" class="form-control" value="{{ old('username') }}" name="name" placeholder="Enter name course">
                @error('name')
            ...
            <div class="form-group ">
                ...
                <textarea type="text" class="form-control" value="{{ old('description') }}" id="exampleInputEmail1" name="description" placeholder="Enter phone" ></textarea>
                @error('description')
            ...
            <div class="form-group ">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" value="{{ old('start_day') }}" id="datepicker" name="start_day">
                </div>
                @error('start_day')
